        ...
        {items.map(({menu, subitems}, index) => {
          ...
          return (
            <>
              <NavLink
                ...
                className={({ isActive, isPending }) =>
                  isPending
                    ...
                    : isActive
                    ? `active ${subitems?.length ? 'submenu-active' : ''} bg-indigo-100 text-indigo-500 font-regular mt-3 flex items-center p-2 pl-6 rounded relative group peer`
              ...
              {subitems?.length && (
                <div  x-ref={menu} className={`text-left max-h-0 overflow-hidden transition-all ease-in-out duration-300	peer-[.submenu-active]:max-h-44`}>
